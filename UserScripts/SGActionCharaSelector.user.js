...
<style type="text/css">
    ...
    .${skillsClassname}{font-size:8px;}
    .${skillsClassname} span.marks.marki0{width:20px;}
    .${skillsClassname} span.marks.marki0+span>span{display:inline-block;width:9px;}
    .${skillsClassname} span.marks.marki0+span+span{width:120px!important;}
    ...
    .${skillsClassname} span.marks.marki0+span+span+small+br+small>span:first-child{padding-left:24px!important;}
